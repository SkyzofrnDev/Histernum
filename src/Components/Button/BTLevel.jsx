...
const BTLevel = () => {
  return (
    <button
      className={`relative inline-flex items-center justify-center w-[70px] h-[65px] rounded-full ${level ? `bg-[#58cc02] overflow-hidden shadow-[0_8px_0_#46a302] active:shadow-[0_2px_0_#46a302]` : "bg-[#37464f] overflow-hidden shadow-[0_8px_0_#2c383f] active:shadow-[0_2px_0_#2c383f]"} active:translate-y-[4px] transition-all duration-100`}
    >
      {level && (<svg
