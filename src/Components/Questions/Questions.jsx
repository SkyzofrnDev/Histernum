...
const Questions = () => {
  return (
    <div className="w-full select-none h-screen flex flex-col bg-[#131f24] py-10 ">
      <div className="flex items-center  gap-4 text-[#ed4140] font-semibold just text-2xl px-36 w-full justify-between py-5">
        <Link to={"/"}>
          <img
